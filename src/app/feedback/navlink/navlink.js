...
function NavLink() {
  ...
  return (
    <nav className='w-full mt-5 flex justify-start'>
      ...
      <Link href = '/feedback/feedbacks' className={`${pathname === '/feedback/feedbacks' ? 'link px-5 py-1 bg-[#5799FD] text-white font-semibold rounded-lg' : 'link rounded-md px-5 py-1 text-black font-semibold'}`}>Appointment Feedback</Link>
