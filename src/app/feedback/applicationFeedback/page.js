...
import { useApplicationFeedbackStore } from './ApplicationFeedbackState';
import FilterChip from "./filterchips";
import ApplicationFeedbackList from '@/app/components/feedback/applicationFeedback/ApplicationFeedbackList';
import ApplicationFeedbackView from '@/app/components/feedback/applicationFeedback/ApplicationFeedbackView';
...
function handleFilteredNextPage() {
  ...
  async function handleSearch (page) {
    try {
      ...
      const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/superadmin/feedback-query`, {
      ...
      feedbackState.setAppFeedbacks(response.data.queryResults);
  ...
  return (
    <div className="w-full h-[85vh] px-7 overflow-y-auto">
      ...
      <div className='w-full h-[90%] mt-2 p-4  bg-white rounded shadow drop-shadow-md '>
        ...
        <div className="w-full h-8 flex justify-between">
          ...
          <div className='w-[65%]  flex'>
            ...
            { (feedbackState.FieldValue  === "Name" || feedbackState.FieldValue  === "User Id") && (
                <>
                  <input
                          type="text"
      ...
      {
        feedbackState.feedbackViewToggle && <ApplicationFeedbackView />
      }
