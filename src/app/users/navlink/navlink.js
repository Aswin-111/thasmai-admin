...
function NavLink() {
  ...
  return (
    ...
    <Link href = '/users/ashram-appointments'className={`${pathname === '/users/ashram-appointments' ? 'link px-5 py-1 bg-[#5799FD] text-white font-semibold rounded-lg' : 'link rounded-md px-5 py-1 text-black font-semibold'}`}>Ashram Appointments</Link>
