    ...
    <div className="w-[100vw] h-[100vh] bg-[#000000af] absolute left-0 top-0 flex justify-center items-center">
        ...
        <div className='w-[1000px] h-[600px] px-10 bg-white'>
            <input 
              ...
              className='w-full h-12  mt-10 border-b-2 border-amber-800 outline-none placeholder:text-xl '
            ...
            <input 
              ...
              className='w-[60%] h-12  mt-10 border-b-2 border-amber-800 outline-none placeholder:text-xl '
              onChange={handleOnChange}
            />
            <input
              name='ans2'
              ...
              className='w-[60%] h-12  mt-5 border-b-2 border-amber-800 outline-none placeholder:text-xl '
              onChange={handleOnChange}
            />
            <input 
              name='ans3'
