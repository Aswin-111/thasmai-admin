...
function ApplicationFeedbackTable() {
  ...
  async function fetchData() {
   try {
    ...
    const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/superadmin/list-feedback`);
...
export default ApplicationFeedbackTable;