...
import EventDetailsTable from '@/app/components/events/events/eventDetailsTable'
import AddEventPopUp from '@/app/components/events/events/AddEventPopUp'
import ViewEventPopUp from '@/app/components/events/events/ViewEventPopUp'
import EditPopUp from '@/app/components/events/events/EditPopUp'
import DeleteEventPopUp from '@/app/components/events/events/DeleteEventPopUp'
...
function EventDetails() {
	...
	async function handleSearch (newPageNo) {
		try {
		  	...
		  	const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/superadmin/events-query`, {
		  	...
		  	filterState.setEventsData(response.data.queryResults);
