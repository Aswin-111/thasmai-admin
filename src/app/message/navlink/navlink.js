    ...
    const pathname = usePathname()
  	...
  	return (
    	<nav className='w-full h-full flex items-center'>
      		...
      		<Link href = '/message/test-global' className={`${pathname === '/message/test-global' ? 'link px-5 py-1 bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md px-5 py-1 bg-[#e0e2ec] text-black font-semibold hover:scale-105'}`}>Global Messages</Link>
      		<Link href = '/message/test-gurujiTab' className={`${pathname === '/message/test-gurujiTab' ? 'link ms-3 px-5 py-1  bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md ms-3 px-5 py-1 bg-[#e0e2ec] text-black font-semibold hover:scale-105'}`}>Guruji Messages</Link>
      		<Link href = '/message/blogs' className={`${pathname === '/message/blogs' ? 'link ms-3 px-5 py-1  bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md ms-3 px-5 py-1 bg-[#e0e2ec] text-black font-semibold hover:scale-105'}`}>Blogs</Link>
