...
function NavLink() {
  ...
  return (
    <nav className='w-full h-full flex items-center'>
      ...
      <Link href = '/appointments/feedbacks' className={`${pathname === '/appointments/feedbacks' ? 'link ms-3  px-5 py-1 bg-[#005DB8] text-white font-semibold rounded-lg' : 'link rounded-md ms-3  px-5 py-1 bg-[#e0e2ec] text-black font-semibold'}`}>Feedbacks</Link>
